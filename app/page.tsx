  ...
  return (
    <div className="relative flex flex-col gap-24 overflow-hidden min-h-screen">
      ...
      >
        ...
        <div className="grid gap-6 grid-cols-1 md:grid-cols-3 max-w-5xl mx-auto w-full">
          {/* Card 1 */}
          <motion.div
            whileHover={{ scale: 1.025, y: -4 }}
            className="card !p-5 flex flex-col items-start gap-4 border-2 border-neutral-300 dark:border-zinc-700 bg-white/60 dark:bg-zinc-900/40 hover:border-emerald-500/45 dark:hover:border-emerald-500/30 transition-all duration-300"
          >
          ...
          <motion.div
            whileHover={{ scale: 1.025, y: -4 }}
            className="card !p-5 flex flex-col items-start gap-4 border-2 border-neutral-300 dark:border-zinc-700 bg-white/60 dark:bg-zinc-900/40 hover:border-saffron-500/45 dark:hover:border-saffron-500/30 transition-all duration-300"
          >
          ...
          <motion.div
            whileHover={{ scale: 1.025, y: -4 }}
            className="card !p-5 flex flex-col items-start gap-4 border-2 border-neutral-300 dark:border-zinc-700 bg-white/60 dark:bg-zinc-900/40 hover:border-blue-500/45 dark:hover:border-blue-500/30 transition-all duration-300"
          >
